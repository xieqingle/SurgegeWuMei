...
public class ToastView {
    ...
    public void toast(String str) {
        View mView = LayoutInflater.from(ResourceUtils.getContext()).inflate(R.layout.toast_custom_layout, null);
        ...
        if (mToast == null || !str.equals(message)) {
            mToast = new Toast(ResourceUtils.getContext());
    ...
    public void toast(String str, int type) {
        View mView = LayoutInflater.from(ResourceUtils.getContext()).inflate(R.layout.toast_custom_layout, null);
        TextView text = (TextView) mView.findViewById(R.id.toast_text);
        ImageView iv = (ImageView) mView.findViewById(R.id.toast_iv);
     ...
     * @param iconRes
     */
    public void toast(String str, int type, int iconRes) {
        View mView = LayoutInflater.from(ResourceUtils.getContext()).inflate(R.layout.toast_custom_layout, null);
        TextView text = (TextView) mView.findViewById(R.id.toast_text);
        ImageView iv = (ImageView) mView.findViewById(R.id.toast_iv);
 ...
 /*   */
    ...
    public static void makeText(String str) {
        if (toast == null || !TextUtils.equals(msg, str)) {
            toast = Toast.makeText(ResourceUtils.getContext(), str, Toast.LENGTH_SHORT);
            toast.show();
            msg = str;
        } else {
            toast.setText(str);
     ...
     */
    public static void makeText(String str, Object longTime) {
        if (toast == null || !TextUtils.equals(msg, str)) {
            toast = Toast.makeText(ResourceUtils.getContext(), str, Toast.LENGTH_LONG);
            toast.show();
            msg = str;
        } else {
            toast.setText(str);
     ...
     * 显示是否居中的Toast
     */
    public static void showText(String str, boolean isCenter) {
        View view = View.inflate(ResourceUtils.getContext(), R.layout.toast_layout, null);
        ...
        ViewUtils.setPadding(llToastLayout, DensityUtils.dp2px(ResourceUtils.getContext(), 60), DensityUtils.dp2px(ResourceUtils.getContext(), 16), DensityUtils.dp2px(ResourceUtils.getContext(), 60), DensityUtils.dp2px(ResourceUtils.getContext(), 16));
        ViewUtils.setTextSize(mTvToast, ResourceUtils.getInteger(R.integer.text_title_size));
        if (toast == null || !TextUtils.equals(str, msg)) {
            toast = new Toast(ResourceUtils.getContext());
